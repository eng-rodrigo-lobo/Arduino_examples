...
void loop() {
  switch (state) {
    case 1: lcd.clear(); lcd.setCursor(0, 0); lcd.print(instrucaoGravar);
      lcd.setCursor(0, 1); lcd.print("Hora 1: "); gravaNumero(); hora_01 = outputNum; state = 2; break;

    case 2: lcd.clear(); lcd.setCursor(0, 0); lcd.print(instrucaoGravar);
      lcd.setCursor(0, 1); lcd.print("Min. 1: "); gravaNumero(); min_01 = outputNum; state = 5; break;

//    case 3: lcd.clear(); lcd.setCursor(0, 0); lcd.print(instrucaoGravar);
//      lcd.setCursor(0, 1); lcd.print("Hora 2: "); gravaNumero(); hora_02 = outputNum; outputNum = 0; state = 4; break;
//
//    case 4: lcd.clear(); lcd.setCursor(0, 0); lcd.print(instrucaoGravar);
//      lcd.setCursor(0, 1); lcd.print("Min. 2: "); gravaNumero(); min_02 = outputNum; outputNum = 0; state = 5; break;

    case 5: lcd.clear(); lcd.setCursor(0, 0); lcd.print(finalProg); lcd.setCursor(0, 1);
      lcd.print("1) "); lcd.print(hora_01); lcd.print("h"); lcd.print(min_01); Serial.println(hora_01+"h"+min_01); delay(5000);
